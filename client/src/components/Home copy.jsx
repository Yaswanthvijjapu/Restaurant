        ...
        <div className="w-full max-w-lg mt-6">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-4">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-green-500 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 w-full sm:w-auto"
            >
              View Restaurants
            </motion.button>
          </div>
        ...
        <div className="w-full max-w-lg mt-8 bg-white p-6 rounded-lg shadow-lg">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-green-500 text-white py-3 px-4 rounded-lg hover:bg-green-600 transition-colors duration-300 w-full sm:w-auto"
            >
              Search Nearby ({radius || 0} km)
            </motion.button>
            <motion.button
              onClick={handleUseMyLocation}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-yellow-500 text-white py-3 px-4 rounded-lg hover:bg-yellow-600 transition-colors duration-300 w-full sm:w-auto"
            >
              Use My Location
            </motion.button>
          </div>
